    ...
    Game.prototype = {
        ...
        initEventMy:function(){
            ...
            $(".show_book").bind("touchstart",function(){
                ...
                var img_str = "<div class='clue_book'><img src='http://p0.ifengimg.com/fe/h5_game_adytum/images/password_a8f1ffec.png' alt=''/></div><div class='close-mask'><img src='http://p0.ifengimg.com/fe/h5_game_adytum/images/nouse_7346f7fd.png' alt=''/></div>"
            ...
            $(".no_use").unbind("touchstart").bind("touchstart",function(){
                ...
                $(".section-documents-container").css("display","block");
                $(".section-clue").css("display","block").siblings().css("display","none");
                var img_str = "<div class='clue'><img src='images/nouse.png' alt=''/></div><div class='close-mask'><img src='http://p0.ifengimg.com/fe/h5_game_adytum/images/close-mask_626c98f2.png' alt=''/></div>"
