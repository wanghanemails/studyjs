...
Base.extend = function(e, t) {
    ...
    var o = i.constructor,
        s = i.constructor = function() {
            if (!Base._prototyping) if (this._constructing || this.constructor == s) this._constructing = !0, o.apply(this, arguments), delete this._constructing;
...
!
    ...
    var e = "undefined" != typeof module && module.exports,
        ...
        n = function() {
            ...
            ], n = 0, i = t.length, o = {}; i > n; n++) if (e = t[n], e && e[1] in document) {
...
"undefined" != typeof NotifyMe && (NotifyMe.myAlert = function(e) {
    console.log(e), alert(0 === e.n ? "æ‚¨å·²é¢„çº¦ï¼Œä¸éœ€è¦å†æ¬¡é¢„çº¦ï¼" : 1 === e.n ? "å·²æˆåŠŸé¢„çº¦UP2017ç›´æ’­ï¼Œæˆ‘ä»¬ä¼šåœ¨ç›´æ’­å¼€å§‹å‰é€šè¿‡QQæ¶ˆæ¯æé†’æ‚¨è§‚çœ‹ï¼" : 2 === e.n ? "å¾ˆæŠ±æ­‰ï¼Œå¯èƒ½æ˜¯ç³»ç»Ÿç¹å¿™ï¼Œè¯·ç¨åŽå†è¯•ï¼" : "å¯èƒ½ä¸åœ¨æ´»åŠ¨æ—¶é—´ï¼Œè¯·ç¨åŽå†è¯•:" + e.n)
...
$(window).on("resize orientationchange", adjustSize), adjustSize(), /iPhone|iPad|iPod|Android/i.test(navigator.userAgent) ? (tryPgvSendClick({
    hottag: "a20170301pre.support.mobile"
}), ismobile = !0, $("body").addClass("mobile"), $(".loadingwrapper").hide(), setTimeout(function() {
    $(".loadingwrapper").show()
}, 1e3), document.title = "UP2017è…¾è®¯äº’å¨±å¹´åº¦å‘å¸ƒä¼š") : tryPgvSendClick({
    ...
    console.log("resloaded"), tryPgvSendClick({
    ...
    console.log("introed"), $(this).addClass("introed"), initFullpage(), tryPgvSendClick({
        hottag: "a20170301pre.page.introed"
    }), introed = !0, startStorm(), setTimeout(function() {
...
}), $.getScript("https://game.gtimg.cn/images/up/act/a20170301pre/js/pkg/webgl_5846b7a.js", function() {}), $("body").addClass("webglyes")) : (tryPgvSendClick(ismobile ? {
    hottag: "a20170301pre.support.mobilewebglno"
} : {
    hottag: "a20170301pre.support.pcwebglno"
}), toggleParticle = function() {}, $("body").addClass("webglno"), $("body").addClass("introed"), $("body").addClass("resloaded"), $("body").addClass("hideloading"), $(".chromeframe").addClass("show"), initFullpage(), tryPgvSendClick({
    hottag: "a20170301pre.page.introed"
