    ...
    Game.prototype = {
        ...
        initEventMy:function(){
            ...
            $(".zaihuang-medication").unbind("touchstart").bind("touchstart",function(){
                ...
                var img_str = "<div class='country-goods'><img src='http://p0.ifengimg.com/fe/h5_game_adytum/images/top3_364e8302.png' alt=''/></div><div class='close-mask'><img src='http://p2.ifengimg.com/a/2017/0512/close-mask.png' alt=''/></div>"
            ...
            $(".yunnan-medication").unbind("touchstart").bind("touchstart",function(){
                ...
                $(".section-documents-container").css("display","block");
                $(".section-documents").css("display","block").siblings().css("display","none");
                var img_str = "<div class='country-goods'><img src='http://p0.ifengimg.com/fe/h5_game_adytum/images/top7_b2c61c5a.png' alt=''/></div><div class='close-mask'><img src='http://p2.ifengimg.com/a/2017/0512/close-mask.png' alt=''/></div>"
            ...
            $(".simulation-train-move").bind("touchstart",function(){
                $(".section-documents-container").css("display","block");
                $(".section-documents").css("display","block").siblings().css("display","none");
                var img_str = "<div class='country-goods'><img src='http://p0.ifengimg.com/fe/h5_game_adytum/images/top1_678659a0.png' alt=''/></div><div class='close-mask'><img src='http://p2.ifengimg.com/a/2017/0512/close-mask.png' alt=''/></div>"
            ...
            $(".huawei-iphone").unbind("touchstart").bind("touchstart",function(){
                $(".section-documents-container").css("display","block");
                $(".section-documents").css("display","block").siblings().css("display","none");
                var img_str = "<div class='country-goods'><img src='http://p0.ifengimg.com/fe/h5_game_adytum/images/top2_0102e177.png' alt=''/></div><div class='close-mask'><img src='http://p2.ifengimg.com/a/2017/0512/close-mask.png' alt=''/></div>"
            ...
            $(".important-paper").unbind("touchstart").bind("touchstart",function(){
                ...
                if(!that.hasLastPuzzle){
                    ...
                    var img_str = "<div class='clue'><img src='http://p0.ifengimg.com/fe/h5_game_adytum/images/photo_7f35e42a.png' alt=''/></div><div class='close-mask'><img src='http://p2.ifengimg.com/a/2017/0512/close-mask.png' alt=''/></div>"
            ...
            $(".simulation-bedside-table").bind("touchstart",function(){
                if(that.hasKey==false){
                    $(".section-documents-container").css("display","block");
                    $(".section-clue").css("display","block").siblings().css("display","none");
                    var img_str = "<div class='clue'><img src='http://p0.ifengimg.com/fe/h5_game_adytum/images/photo_clue02_5f03f5c5.png' alt=''/></div><div class='close-mask'><img src='http://p2.ifengimg.com/a/2017/0512/close-mask.png' alt=''/></div>"
                    ...
                    var img_str = "<div class='clue_calendar' id='clue_calendar'><img src='http://p0.ifengimg.com/fe/h5_game_adytum/images/in_table_clue_87476e3a.png' alt=''/></div><div class='close-mask'><img src='http://p2.ifengimg.com/a/2017/0512/close-mask.png' alt=''/></div>"
                    ...
                    $("#clue_calendar").bind("touchstart",function(){
                        ...
                        $(".section-documents").css("display","block").siblings().css("display","none");
                        var img_str = "<div class='country-goods'><img src='http://p0.ifengimg.com/fe/h5_game_adytum/images/top8_635ec299.png' alt=''/></div><div class='close-mask'><img src='http://p2.ifengimg.com/a/2017/0512/close-mask.png' alt=''/></div>"
            ...
            $(".complete_puzzle").unbind("touchstart").bind("touchstart",function(){
                ...
                if(that.hasLastPuzzle&&that.hasCompletPuzzle&&that.hasKey){
                    $(".section-documents-container").css("display","block");
                    $(".section-documents").css("display","block").siblings().css("display","none");
                    var img_str = "<div class='country-goods'><img src='http://p0.ifengimg.com/fe/h5_game_adytum/images/top6_cc3cb7e3.png' alt=''/></div><div class='close-mask'><img src='http://p2.ifengimg.com/a/2017/0512/close-mask.png' alt=''/></div>"
                    ...
                    $(".section-documents-container").css("display","block");
                    $(".section-clue").css("display","block").siblings().css("display","none");
                    var img_str = "<div class='clue'><img src='http://p0.ifengimg.com/fe/h5_game_adytum/images/photo_clue01_430b6bb5.png' alt=''/></div><div class='close-mask'><img src='http://p2.ifengimg.com/a/2017/0512/close-mask.png' alt=''/></div>"
                    ...
                    //$(".section-documents-container").css("display","block");
                    //$(".section-clue").css("display","block").siblings().css("display","none");
                    //var img_str = "<div class='clue'><img src='http://p0.ifengimg.com/fe/h5_game_adytum/images/key_620f260c.png' alt=''/></div><div class='close-mask'><img src='http://p2.ifengimg.com/a/2017/0512/close-mask.png' alt=''/></div>"
                    //
                    //$(".section-clue").html(img_str);
                    //that.hasLastPuzzle = true;
                    //that.hasKey = true;
            ...
            $(".uva").unbind("touchstart").bind("touchstart",function(){
                ...
                if(!that.controller_uva){
                    $(".section-documents-container").css("display","block");
                    $(".section-documents").css("display","block").siblings().css("display","none");
                    var img_str = "<div class='country-goods'><img src='http://p0.ifengimg.com/fe/h5_game_adytum/images/top5_7dfc61d4.png' alt=''/></div><div class='close-mask'><img src='http://p2.ifengimg.com/a/2017/0512/close-mask.png' alt=''/></div>"
